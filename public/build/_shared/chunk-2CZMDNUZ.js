...
})(["width:100%;flex:1;display:flex;flex-direction:column;align-items:center;justify-content:end;@media (max-width:", "){padding-top:0px;}"], size.md);
var logolist = [{
  name: "linkdin.png",
...
var Footer = () => {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(MainContainer, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Box, { display: "flex", backgroundColor: "#673AB7", justifyContent: "center", w: "100%", height: "250px", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Box, { mt: "80px", display: "flex", flexDirection: "column", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Box, { display: "flex", children: logolist.map(({
        name,
        link,
        email,
        phoneNumber
      }) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("a", { target: "_blank", href: `${link}`, children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Image, { onClick: () => {
          email && handleClickEmail(email);
          phoneNumber && handlePhoneCall(phoneNumber);
        }, cursor: "pointer", p: "5px", src: `/${name}`, pt: "30px", height: {
          md: "70px",
          sm: "60px"
        } }, void 0, false, {
          fileName: "app/components/Footer.tsx",
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Box, { pl: 25, zIndex: 1, children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Image, { src: "/computer.png", pt: "30px", height: {
      md: "230px",
      sm: "220px"
    } }, void 0, false, {
      fileName: "app/components/Footer.tsx",
