...
function useDescendant(options) {
  ...
  const [index2, setIndex] = (0, import_react62.useState)(-1);
...
function useClickable(props = {}) {
  ...
  const [isButton, setIsButton] = (0, import_react72.useState)(true);
...
function useDisclosure(props = {}) {
  ...
  const onToggle = (0, import_react75.useCallback)(() => {
    if (isOpen) {
      onClose();
    } else {
      onOpen();
...
function useAnimationState(props) {
  ...
  const [once2, setOnce] = (0, import_react77.useState)(false);
...
function useMenu(props = {}) {
  ...
  const onOpenInternal = (0, import_react78.useCallback)(() => {
  ...
  const openAndFocusMenu = (0, import_react78.useCallback)(() => {
    onOpen();
    focusMenu();
  }, [onOpen, focusMenu]);
  const timeoutIds = (0, import_react78.useRef)(/* @__PURE__ */ new Set([]));
  useUnmountEffect2(() => {
    timeoutIds.current.forEach((id22) => clearTimeout(id22));
    timeoutIds.current.clear();
  });
  const openAndFocusFirstItem = (0, import_react78.useCallback)(() => {
    onOpen();
    focusFirstItem();
  }, [focusFirstItem, onOpen]);
  const openAndFocusLastItem = (0, import_react78.useCallback)(() => {
    onOpen();
    focusLastItem();
  ...
  useUpdateEffect(() => {
    ...
    if (isFocused && !trulyDisabled && ref.current) {
      ...
      rafId.current = requestAnimationFrame(() => {
        var _a7;
        (_a7 = ref.current) == null ? void 0 : _a7.focus();
        rafId.current = null;
      });
